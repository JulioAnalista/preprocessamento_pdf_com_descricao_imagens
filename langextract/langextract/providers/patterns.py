...
AZURE_OPENAI_PATTERNS = (
    r'^azure-gpt',  # azure-gpt-4, azure-gpt-5, etc.
    r'^gpt-5-nano',  # gpt-5-nano, gpt-5-nano-sf, etc.
    r'^gpt-5-mini',  # gpt-5-mini, etc.
    r'^azure:',  # azure:gpt-4, azure:gpt-5, etc.
)
AZURE_OPENAI_PRIORITY = 15  # Higher priority than regular OpenAI
